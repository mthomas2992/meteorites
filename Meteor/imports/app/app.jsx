...
class App extends React.Component {
    ...
    render() {
      ...
      if (this.props.path == "Home"){
        return (<div id="home"><h1 id="header">Meteorites: SENG</h1>
                <h2> What are we even doing here????</h2>
                <p> After a rather successful attempt at SENG2021, we decided we had to try it <ahref="https://www.youtube.com/watch?v=FGBhQbmPwH8">one more time</a>. As a result, we are here, writing more really well written and honestly, better than ever solutions to arbitrary problems that we are given. Given this is the last SENG workshop, we want to make it count and do even better than last time. Thats why we bought a URL this time ( ͡° ͜ʖ ͡°)</p>
                <br></br>
